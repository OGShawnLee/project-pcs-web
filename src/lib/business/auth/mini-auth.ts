...
export default class MiniAuthClient<AuthState extends { id: string }, User extends object> {
	...
	private ACCESS_TOKEN_EXPIRES_IN: MiniAuthClientConfiguration<
		AuthState,
		User
	>['env']['ACCESS_TOKEN_EXPIRES_IN'];
	private ACCESS_COOKIE_NAME: MiniAuthClientConfiguration<
		AuthState,
		User
	>['env']['ACCESS_COOKIE_NAME'];
	private REFRESH_TOKEN: MiniAuthClientConfiguration<AuthState, User>['env']['REFRESH_TOKEN'];
	private REFRESH_TOKEN_EXPIRES_IN: MiniAuthClientConfiguration<
		AuthState,
		User
	>['env']['REFRESH_TOKEN_EXPIRES_IN'];
	private REFRESH_COOKIE_NAME: MiniAuthClientConfiguration<
		AuthState,
		User
	...
	private initialFindCurrentUser: MiniAuthClientConfiguration<
		AuthState,
		User
	>['findCurrentUserFromDB'];
	private incrementRefreshTokenVersion: MiniAuthClientConfiguration<
		AuthState,
		User
	>['incrementRefreshTokenVersion'];
	private getRefreshTokenFromDB: MiniAuthClientConfiguration<
		AuthState,
		User
	>['getRefreshTokenFromDB'];
	private getRefreshedAuthState: MiniAuthClientConfiguration<
		AuthState,
		User
	>['getRefreshedAuthState'];
	...
	private createRefreshCookie(refreshTokenVersion: number) {
		return JWT.sign({ version: refreshTokenVersion }, this.REFRESH_TOKEN, {
	...
	private async handleRefreshedAuthState(
		cookies: Cookies,
		decoded: AuthState
	...
	public findCurrentUserFromDB(
		cookies: Cookies
	): Promise<Result<User | null, UserDisplayableException>> {
	...
	private setAccessCookieAndRefreshCookie(
		cookies: Cookies,
		payload: AuthState,
